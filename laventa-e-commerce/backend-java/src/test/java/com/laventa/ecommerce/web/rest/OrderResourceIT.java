...
import com.laventa.ecommerce.domain.Order;
import com.laventa.ecommerce.repository.OrderRepository;
...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().status(DEFAULT_STATUS).createdOn(DEFAULT_CREATED_ON).updatedOn(DEFAULT_UPDATED_ON);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().status(UPDATED_STATUS).createdOn(UPDATED_CREATED_ON).updatedOn(UPDATED_UPDATED_ON);
        return order;
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.status(UPDATED_STATUS).createdOn(UPDATED_CREATED_ON).updatedOn(UPDATED_UPDATED_ON);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.status(UPDATED_STATUS).updatedOn(UPDATED_UPDATED_ON);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.status(UPDATED_STATUS).createdOn(UPDATED_CREATED_ON).updatedOn(UPDATED_UPDATED_ON);

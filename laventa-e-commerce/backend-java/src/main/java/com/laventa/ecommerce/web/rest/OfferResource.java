...
import com.laventa.ecommerce.service.OfferService;
...
/**
 * REST controller for managing {@link com.laventa.ecommerce.domain.Offer}.
 */
@RestController
@RequestMapping("/api")
public class OfferResource {
    ...
    private static final String ENTITY_NAME = "laventaEcommerceOffer";
    ...
    public List<Offer> getAllOffers(@RequestParam(required = false) String filter) {
        if ("product-is-null".equals(filter)) {
            log.debug("REST request to get all Offers where product is null");
            return offerService.findAllWhereProductIsNull();
        }

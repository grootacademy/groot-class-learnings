...
import com.laventa.ecommerce.service.ReviewService;
...
/**
 * REST controller for managing {@link com.laventa.ecommerce.domain.Review}.
 */
@RestController
@RequestMapping("/api")
public class ReviewResource {
    ...
    private static final String ENTITY_NAME = "laventaEcommerceReview";

...
import com.laventa.ecommerce.service.CartService;
...
/**
 * REST controller for managing {@link com.laventa.ecommerce.domain.Cart}.
 */
@RestController
@RequestMapping("/api")
public class CartResource {
    ...
    private static final String ENTITY_NAME = "laventaEcommerceCart";
    ...
    public List<Cart> getAllCarts(@RequestParam(required = false) String filter) {
        if ("customer-is-null".equals(filter)) {
            ...
            return cartService.findAllWhereCustomerIsNull();
        }

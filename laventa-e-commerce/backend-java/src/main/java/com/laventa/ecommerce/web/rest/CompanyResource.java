...
import com.laventa.ecommerce.service.CompanyService;
...
/**
 * REST controller for managing {@link com.laventa.ecommerce.domain.Company}.
 */
@RestController
@RequestMapping("/api")
public class CompanyResource {
    ...
    private static final String ENTITY_NAME = "laventaEcommerceCompany";
    ...
    public List<Company> getAllCompanies(@RequestParam(required = false) String filter) {
        if ("customer-is-null".equals(filter)) {
            log.debug("REST request to get all Companys where customer is null");
            return companyService.findAllWhereCustomerIsNull();
        }

...
import com.laventa.ecommerce.service.OrderService;
...
/**
 * REST controller for managing {@link com.laventa.ecommerce.domain.Order}.
 */
@RestController
@RequestMapping("/api")
public class OrderResource {
    ...
    private static final String ENTITY_NAME = "laventaEcommerceOrder";

        ...
        return customerRepository
            ...
            .map(existingCustomer -> {
                ...
                if (customer.getProfileImg() != null) {
                    existingCustomer.setProfileImg(customer.getProfileImg());
                }
                if (customer.getProfileImgContentType() != null) {
                    existingCustomer.setProfileImgContentType(customer.getProfileImgContentType());
                }
